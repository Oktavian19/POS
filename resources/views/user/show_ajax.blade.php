...
@else 
    <form action="{{ url('/user/' . $user->user_id.'/show_ajax') }}" method="POST" id="form-show"> 
    @csrf 
    @method('POST') 
    <div id="modal-master" class="modal-dialog modal-lg" role="document"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <table class="table table-sm table-bordered table-striped"> 
                    <tr><th class="text-right col-3">Nama :</th><td class="col-9">{{ $user->user_id }}</td></tr> 
                    ...
                    <tr><th class="text-right col-3">Password :</th><td class="col-9">********</td></tr>  
                </table> 
            </div> 
