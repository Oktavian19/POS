...
@else 
    <form action="{{ url('/barang/' . $barang->barang_id.'/show_ajax') }}" method="POST" id="form-show"> 
    @csrf 
    @method('POST') 
    <div id="modal-master" class="modal-dialog modal-lg" role="document"> 
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <table class="table table-sm table-bordered table-striped"> 
                    ...
                    <tr><th class="text-right col-3">Supplier :</th><td class="col-9">{{ $barang->supplier->supplier_nama }}</td></tr>
                </table> 
            </div> 
