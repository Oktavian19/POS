                    ...
                    <div class="col-11">
                        <select class="form-control" id="kategori_id" name="kategori_id" required>
                            ...
                            @foreach($kategori as $item)
                                <option value="{{ $item->kategori_id }}" @if($item->kategori_id == $item->kategori_kode) selected @endif>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="display_harga_beli" value="{{ old('harga_beli') }}"
                                required oninput="formatNumber(this, 'harga_beli')">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="display_harga_jual" value="{{ old('harga_jual') }}"
                                required oninput="formatNumber(this, 'harga_jual')">
