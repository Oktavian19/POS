...
class SupplierController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'supplier_kode' => 'required|string|max:10|unique:m_supplier,supplier_kode', // supplier_kode harus diisi, string, maksimal 10 karakter, dan unik di tabel m_supplier kolom supplier_kode
        ]);
    ...
    public function update(Request $request, string $id)
    {
        $request->validate([
            'supplier_nama' => 'required|string|max:100',  // nama harus diisi, berupa string, dan maksimal 100 karakter
            'supplier_kode' => 'required|string|max:10|unique:m_supplier,supplier_kode,' . $id . ',supplier_id', // supplier_kode harus diisi, string, maksiumal 10 karakter, dan unik di tabel m_supplier kolom supplier_kode
        ]);
