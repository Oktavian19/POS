...
class UserController extends Controller
{
    ...
    public function update(Request $request, string $id) {
        $request->validate([
            ...
            // dan bernilai unik di tabel m_user kolom username kecuali untuk user yang sedang diedit
    ...
    public function destroy(string $id){
        ...
        if (!$check) { // untuk melakukan cek apakah data user dengan id yang dimaksud ada atau tidak
